...
2. Write a Julia function that efficiently evaluates the log posterior density (See [Performance Tips](https://ndmarco.github.io/AdaptEllipticalSliceSampler.jl/dev/generated/Performance/) and [Tutorials](https://ndmarco.github.io/AdaptEllipticalSliceSampler.jl/dev/generated/Regression/) pages)
3. Call the `AGESS` function (See [Tutorials](https://ndmarco.github.io/AdaptEllipticalSliceSampler.jl/dev/generated/Regression/) pages)
