...
1. Multimodal Distributions (Examples considered: [Twin Banana](assets/Banana.md), [Deep GP](assets/Deep_GP.md))
2. Distributions with locally-varying curvature (Examples considered: [Banana](assets/Banana.md), [High-Dimensional Regression with Horseshoe prior](assets/Regression.md), [Deep GP](assets/Deep_GP.md),
