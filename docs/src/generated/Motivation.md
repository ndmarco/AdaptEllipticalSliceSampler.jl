...
[Download this page as a Jupyter notebook](notebooks/Motivation.ipynb)
...
````
Volcano_turing (generic function with 2 methods)
````
...
````
complex_target (generic function with 2 methods)
````
