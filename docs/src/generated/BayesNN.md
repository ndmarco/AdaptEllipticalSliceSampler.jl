...
[Download this tutorial as a Jupyter notebook](notebooks/BayesNN.ipynb)
...
````
transformed_log_posterior (generic function with 1 method)
````
...
````
transformed_log_posterior (generic function with 2 methods)
````
