```@meta
EditURL = "../../literate/Constrained.jl"
```
...
[Download this tutorial as a Jupyter notebook](notebooks/Constrained.ipynb)
...
log pdf (up to a constant).

!!! note
    This function can be implemented more efficiently, however
